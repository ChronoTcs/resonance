...
class HomeRecentPlaysSection extends ConsumerWidget {
  const HomeRecentPlaysSection({super.key});
...
class _RecentPlaysHeader extends StatelessWidget {
  final VoidCallback onClear;

  const _RecentPlaysHeader({required this.onClear});
...
class _RecentPlayCard extends ConsumerWidget {
...
typedef ExploreRecentPlaysSection = HomeRecentPlaysSection;
